...
import data_analysis.utils.starma_utils as utils
...
class STARMA:
    ...
    def bic(self):
        if not self._model or 'bic' not in self._model:
            raise AttributeError("Model not fitted or BIC not available.")
        return self._model['bic']
