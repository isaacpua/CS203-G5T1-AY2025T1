...
TEST_URL = "https://finance.yahoo.com/news/trump-lula-seek-meeting-malaysia-141451087.html"
...
async def main():
    ...
    try:
        ...
        async with client:
            ...
            if "scrape_single_url" in tool_names:
                print(f"\n📞 Calling 'scrape_single_url' for URL: {TEST_URL}...")
                print(f"User Agent: {USER_AGENT}")
                result = await client.call_tool("scrape_single_url", {"url": TEST_URL, "user_agent": USER_AGENT})
                ...
                print("❌ Error: 'scrape_single_url' tool not found on this server endpoint.")
