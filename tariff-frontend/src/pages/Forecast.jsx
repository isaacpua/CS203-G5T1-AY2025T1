  ...
  return (
    <TooltipProvider>
      <div className="w-full">
        {/* Header Section */}
        <div className="px-4 md:px-6 py-6 border-b bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-foreground">Forecasts</h1>
        ...
        {/* Content Section */}
        <div className="px-0 pt-4 md:pt-6 pb-6 md:pb-8">
